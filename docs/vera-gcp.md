...
Local Google Compute Engine — 91 resource types (instances, disks, networks, firewalls, load balancers, and more) running on your machine with no GCP account needed.

Check out the [Vera website](https://project-vera.github.io/) for more information. And the [Vera GCP repository](https://github.com/project-vera/vera-gcp) for the code.
